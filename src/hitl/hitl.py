...
hitl_decision_points = [
    {
        ...
        "trigger": "When the agent identifies a high-risk action (e.g., transfer money, close account)",
        "hitl_model": "human-in-the-loop",
        "context_needed": "Full conversation history, identified action type, confidence score, and relevant account information",
        "example": "User asks to transfer $10,000 to an external account. The agent detects this as a high-risk action and routes it to a human reviewer with all the necessary context to make an informed decision on whether to approve or deny the request.",
    },
    {
        "id": 2,
